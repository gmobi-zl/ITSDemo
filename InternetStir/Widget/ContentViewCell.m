...
-(void)showDataWithModel:(NSInteger)index{
    ...
    self.titleLabel.frame = CGRectMake(60, 0, self.bounds.size.width - 70, 40);
    self.titleLabel.font = [UIFont systemFontOfSize:14];
    self.titleLabel.textColor = [UIColor blackColor];
...
//    self.titleLabel.frame = frame;
    ...
    self.icon.frame = CGRectMake(0, 50 , [[UIScreen mainScreen] bounds].size.width ,  3 * ([[UIScreen mainScreen] bounds].size.width - 30)/4);
    ...
    self.line.frame = CGRectMake(0, self.sourceLabel.frame.origin.y + 20 + 5, screenW, 0.5);
